...
class PlaceRepository {
  ...
  PlaceRepository(this.remoteDataSource);

  Future<Either<Failure, List<Department>>> getSearchPlace(var body) async {
    try {

      final obj = await remoteDataSource!.getSearchPlace(body);
      listDepartments=obj;
